...
@Controller
@RequestMapping
public class BankIDResponseServlet extends HttpServlet {
   ...
   private static final long serialVersionUID = 3734847325014355167L;
    ...
    private final Logger log = LoggerFactory.getLogger(BankIDResponseServlet.class);

    BankIDResponseServlet(BankIDProperties bankIDProperties, BankIDCache bankIDCache) {
